...
public class BuyingCommand extends RizpaCommand {
    public BuyingCommand(String stockSymbol, CommandType type, double price, int amount, User buyer) {
        super(stockSymbol, type, price, amount, buyer, null);
    }
    ...
    public BuyingCommand clone() {
        ...
        return new BuyingCommand(this.stockSymbol, commandType, this.price, this.amount, this.buyer);
    }
}
