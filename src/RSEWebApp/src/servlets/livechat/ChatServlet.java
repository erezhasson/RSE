...
import livechat.SingleChatEntry;
...
public class ChatServlet extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ChatAndVersion cav = new ChatAndVersion(username, chatEntries, chatManagerVersion);
        Gson gson = new Gson();
    ...
    private static class ChatAndVersion {
        ...
        public ChatAndVersion(String username, List<SingleChatEntry> entries, int version) {
